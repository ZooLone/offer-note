...
<div id="invoice">
  <form action="index.php?iid=<?=$data->base->id;?>" method="post">
    ...
    <table style="float:right; width: 220px; line-height: 1.5em; border-collapse: collapse;">
      <tbody>
        <tr>
          <th>AngebotsBestätigungs Nr.:</th>
          <td><?=$prefix;?><?=$data->base->id + $offset;?></td>
        </tr>
        <tr>
            <th>Angebots-Best&auml;tigung:</th>
        ...
        <tr>
         ...
         <tr>
          <th>Mailspool Aktivieren:</th>
          <td><input type="checkbox" name="mailspool" value="mailspool"></td>
        </tr>
         <th>Mailspool Versandfreigabe:</th>
          <td><input type="checkbox" name="send_approval" value="1"></td>
      </tbody>
    </table>
    <br class="clear">
    <br>
    ...
    <input name="print" type="submit" value="Angebot Best&auml;tigen" />
  </form>
</div>
