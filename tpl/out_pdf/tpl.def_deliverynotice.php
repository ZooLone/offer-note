...
if ($booBlanko) $pdf->Output($path_to_gsales.$cfg['dir_data'].$cfg['dir_documents'].$docname,'F');
else  $pdf->Output($path_to_gsales.$cfg['dir_data'].$cfg['dir_documents'].$docname,'F');
